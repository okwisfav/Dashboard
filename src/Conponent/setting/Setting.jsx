...
function Setting() {
  return (
    ...
    <div className= "visibility">
         <h1>How To Set Your Account</h1>
         <p>Our Account is embedded in our name. Reliance revolves around reliability, quality, commitment satisfaction and professionalism.</p>
    </div>
